from fastapi import APIRouter, status, FastAPI, Request
...
async def index_project(request: Request, project_id: str, push_request: PushRequest):
    ...
    nlp_controller = NLPController( # fetch arguments from main
    ...
    while has_records:
        ...
        is_inserted = await nlp_controller.push_chunks_to_index(
            project=project,
            chunks=page_chunks,
...
async def _search_index(request: Request, project_id: str, search_request: SearchRequest):
    project_model = await ProjectModel.create_instance(
            db_client=request.app.db_client
    )
