...
class NLPController(BaseController):
    ...
    def create_collection_name(self, project_id: str): # each vector store has it own naming conventions
    ...
    def get_vector_db_collection_info(self, project: Project):
        ...
        return json.loads(
            json.dumps( # convert Object to JSON string
                collection_info, # is not an object that you JSON can handle directly so we use:
    ...
    def index_into_vector_db(self, project: Project, chunks: List[DataChunk], 
        ...
        metadatas = [chunk.chunk_meta for chunk in chunks]
        ...
        # step3: create collection if not existed
        ...
        # step4: insert items into vectordb
